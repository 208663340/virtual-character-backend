...
import com.nageoffer.shortlink.xunzhi.toolkit.ai.AgentPropertiesLoader;
import com.nageoffer.shortlink.xunzhi.toolkit.ai.XingChenAIClient;
...
public class AgentMessageServiceImpl implements AgentMessageService{
     ...
     * 验证用户登录状态
     */
    public void validateUserLogin(String username, String token) {
